...
public record TerminalView(List<VesselResponse>vessels,WorkQueueResult workQueue,List<ColorSetResponse>colorSets,List<RobContainer>robContainers,List<CellMatrix>cellMatrix,String vesselId,String bay,String deckHold,String qType,int remainContainers,int sequenceCount,int dgCount,int poweredCount,int tankCount,int oogCount,int twinCount,int tandemCount,int quadCount,String queueStatus){}
