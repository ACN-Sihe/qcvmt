...
<body>
<c:url var="actionUrl" value="/user/updateVessel.html" />
	<div id="d1">
			...
			<form:form modelAttribute="vessel" method="POST" action="${actionUrl}" onsubmit="return checkValue();">
				<table cellpadding="0" cellspacing="0" style="text-align:center;" width="100%" >
					<tr>
						...
						<td align="center"><input type="text" id="vesselid" name="vesselid" title="vesselid" maxlength="30"  value='<c:out value="${vessel.vesselid }"></c:out>' /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="center"><input type="text" id="bay" name="bay" title="bay" maxlength="3"  value='<c:out value="${vessel.bay }"></c:out>' /></td>
					</tr>
					<tr>
						<td align="right"><spring:message code="rows" /> :</td>
						<td align="center"><input type="text" id="rowStart" name="rowStart" title="rowStart" maxlength="2"  value='<c:out value="${vessel.rowStart }"></c:out>' /></td>
						<td align="left"><input type="text" id="rowEnd" name="rowEnd" title="rowEnd" maxlength="3"  value='<c:out value="${vessel.rowEnd }"></c:out>' /></td>
					</tr>
					<tr>
						<td align="right"><spring:message code="tiers" /> :</td>
						<td align="center"><input type="text" id="TierStart" name="tierStart" title="tierStart" maxlength="2"  value='<c:out value="${vessel.tierStart }"></c:out>' /></td>
						<td align="left"><input type="text" id="TierEnd" name="tierEnd" title="tierEnd" maxlength="2"  value='<c:out value="${vessel.tierEnd }"></c:out>' /></td>
					</tr>
					
					<tr>
						<td><input type="hidden" id="id" name="id" value='<c:out value="${vessel.id }"></c:out>'/></td>
					</tr>
					<tr height="50">
